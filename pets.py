...
seed = 0
env = cartpole_env.CartPoleEnv()#cartpole是OpenAI gym中的一个游戏测试
env.seed(seed)
...
#Hydra configuration
#MBRL-Lib uses Hydra to manage configurations. 
# For the purpose of this example, you can think of the configuration object as a dictionary 
# with key/value pairs--and equivalent attributes--that specify the model and algorithmic options.
#  Our toolbox expects the configuration object to be organized as follows:
trial_length = 200
num_trials = 10
ensemble_size = 5
...
#CEM Agent
#create an agent that can plan using the Cross-Entropy Method over the model environment created above
